  ...
  return [
    {
      name: 'bash',
      description:
        "Execute a bash command. Use for file operations, git, running scripts, etc. Always explain what you're about to do.",
      input_schema: {
        type: 'object',
        properties: {
          command: {
    ...
    },
    {
      name: 'applescript',
      description:
        'Run AppleScript on macOS via osascript. Requires explicit user permission (/grant_access).',
      input_schema: {
        type: 'object',
        properties: {
          script: {
    ...
    },
    {
      name: 'read_file',
      description:
        'Read the contents of a file from the filesystem (workspace-scoped). Use this to view code, configs, or any text files.',
      input_schema: {
        type: 'object',
        properties: {
          path: {
    ...
    },
    {
      name: 'write_file',
      description:
        'Write content to a file (workspace-scoped). Creates new file or overwrites existing.',
      input_schema: {
        type: 'object',
        properties: {
          path: {
    ...
    },
    {
      name: 'glob',
      description:
        'Find files matching a pattern in the filesystem using glob patterns (workspace-scoped).',
      input_schema: {
        type: 'object',
        properties: {
          pattern: {
    ...
    },
    {
      name: 'grep',
      description:
        'Search for text patterns within files (workspace-scoped). Useful for finding code or configuration.',
      input_schema: {
        type: 'object',
        properties: {
          pattern: {
    ...
    },
    {
      ...
      description:
        'List Google Analytics properties via gac CLI. If accountId is omitted, scans all accounts.',
      input_schema: {
        type: 'object',
        properties: {
          accountId: {
